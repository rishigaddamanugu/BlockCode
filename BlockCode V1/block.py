...
class Block:
    def __init__(self, x, y, label, model_block=None, run_block=None, data_block=None, data_converter=None, operation_block=None, num_inputs=1, num_outputs=1):
        ...
        self.operation_block = operation_block
