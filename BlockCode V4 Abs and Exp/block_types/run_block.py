...
class RunBlock:
    ...
    def generate_code(self, composite_block, data_block):
        """Generate the code for this block."""
        if not composite_block:
...
class InferenceBlock(RunBlock):
    ...
    def generate_code(self, data_block):
        ## **TODO** Reconfigure to use composite_block to import and use specific model instead of generic model
        params = self.params
